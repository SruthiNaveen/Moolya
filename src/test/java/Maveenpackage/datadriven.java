...
public void test1() throws IOException {
 File excel=new File("/Users/srimoksham/Desktop/Datadriven.xlsx");  //location of the file
 FileInputStream fis=new FileInputStream(excel);                      //input the data from the file and also read data ofthe file of excel 
 @SuppressWarnings("resource")
XSSFWorkbook book=new XSSFWorkbook(fis);                             //collection of sheets is a workbook(excel) Xsssf work book format 
